...
# train_num 50;  thresh 4
# train_num 200; thresh 3
def parse_args():
    import argparse
    ...
    parser.add_argument('--patch', type=int, default=19,help='15,19')
    parser.add_argument('--epochs', type=int, default=300)
    parser.add_argument('--dataset', default='Indian_pines')
    parser.add_argument('--group', type=int, default=4, help='group number 2,8')
